...
function ProfilePage({ user, onLogout, setUser }) {
    ...
    const openModal = () => {
        if (user.address && user.phone) {
            ...
            alert(
                "You need to enter your phone number and address to add books"
            );
        }
    };
                        ...
                        >
                            <form onSubmit={addAddress}>
                                ...
                                <Modal.Body>
                                    ...
                                    >
                                        Do not enter your exact address, just a
                                        rough locality. This address will be
                                        public. Example: Sector 4<br></br>
                                    </small>
